...
List itemQuerrykodu(var ddata, String q1, String c1) {
  int x = 0;
  //int counter = 0;
  var a = [];
...
Post dataarrayUrunkodu(var dataArray, String kodu) {
  ...
  for (int time = 0; time < 24; time++) {
    ...
    ldata.add(new TimeSeriesSales(
        new DateTime(2017, 9, 1, time),
        hourQuerry(itemQuerrykodu(dataArray, "kodu", kodu), "zaman",
                time.toString())
            .length));
  }
...
List<Post> parsePostsUrunkodu(var dataArray) {
  ...
  for (int x in range) {
    give.add(dataarrayUrunkodu(dataArray, x.toString()));
  }
  return give;
}
